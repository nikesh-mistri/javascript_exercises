...
populationOfEngland = unitedKingdom[1].population
populationOfWales = unitedKingdom[2].population
populationOfNorthenIreland = unitedKingdom[3].population

// if (populationOfScotland > populationOfEngland && populationOfWales && populationOfNorthenIreland){
//     console.log("The population of SCotland is the biggest.")

// } else if (populationOfScotland < populationOfEngland && populationOfWales && populationOfNorthenIreland){
...
if (unitedKingdom[0].population > unitedKingdom[1].population && unitedKingdom[2].population && unitedKingdom[3].population){
    console.log("The population of SCotland is the biggest.")

} else if (unitedKingdom[0].population < unitedKingdom[1].population && unitedKingdom[2].population && unitedKingdom[3].population){
    console.log("The population of Scotland is the smallest.")
